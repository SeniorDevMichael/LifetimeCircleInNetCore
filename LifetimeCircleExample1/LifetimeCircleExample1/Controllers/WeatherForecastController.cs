...
namespace LifetimeCircleExample1.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public WeatherForecastController(RandomGenerator randomGenerator1, RandomGenerator randomGenerator2,
        ...
        {
            int number1 = randomGenerator1.Number;
            int number2 = randomGenerator2.Number;
